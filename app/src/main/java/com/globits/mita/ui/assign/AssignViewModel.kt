...
class AssignViewModel @AssistedInject constructor(
    ...
    override fun handle(action: AssignViewAction) {
        when (action) {
            ...
            is AssignViewAction.GetLabTestAssignTemplate -> getLabTestAssignTemplate()
